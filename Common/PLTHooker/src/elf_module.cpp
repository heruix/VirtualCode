...
void elf_module::dump_rel_info(void)
{
    ...
    size_t resszs[] = {this->m_reldyn_bytes/sizeof(ElfW(Rel)), this->m_relplt_bytes/sizeof(ElfW(Rel))};
...
void elf_module::dump_rela_info(void)
{
    ...
    size_t resszs[] = {this->m_reldyn_bytes/sizeof(ElfW(Rela)), this->m_relplt_bytes/sizeof(ElfW(Rela))};
