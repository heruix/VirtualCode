...
#if USE_ASMHOOKER
extern "C" void *__libc_init(void *arg0, void *arg1, const void *fnmain, void *arg3,
...
static void *hijack_libc_init(void *arg0, void *arg1, const void *fnmain, void *arg3,
    ...
    return ((void *(*)(void *, void *, const void *, void *, void *, void *, void *, void *))
        hijack_libc_init_orig)(arg0, arg1, vmmain, arg3, arg4, arg5, arg6, arg7);
}
...
static void __attribute__((constructor)) __init__() {
    ...
    hooker.hook_all_modules("__libc_init", (void *)hijack_libc_init, &hijack_libc_init_orig);
#else
    WInlineHookFunction((void *)__libc_init, (void *)hijack_libc_init, &hijack_libc_init_orig);
#endif
}
